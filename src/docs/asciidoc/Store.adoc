...
==== GET - /api/stores/search?x-coordinate={xCoordinate}&y-Coordinate={yCoordinate}&keyword={keywords}&size={size}&page={page}
...
==== GET - /api/stores/search?x-coordinate={xcoordinate}&y-coordinate={yCoordinate}&keyword={keywords}sort-by={sortBy}&size={size}&page={page}
