...
.Request
include::{snippets}/order-find-by-id-success/path-parameters.adoc[]
include::{snippets}/order-find-by-id-success/http-request.adoc[]

==== Response

.Response
include::{snippets}/order-find-by-id-success/http-response.adoc[]
include::{snippets}/order-find-by-id-success/response-fields.adoc[]
