...
public interface MemberRepository extends JpaRepository<Member, Long> {
	...
	@Query("SELECT m FROM Member m JOIN FETCH m.memberRoles mr JOIN FETCH mr.role WHERE m.providerId = :providerId")
	Optional<Member> findMemberWithRolesAndRoleByProviderId(@Param("providerId") Long providerId);
